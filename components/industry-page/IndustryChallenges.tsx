...
export default function IndustryChallenges({ industry }: { industry: IndustryPageData }) {
  return (
    <section className="py-24 bg-gradient-to-br from-red-50 via-orange-50 to-slate-50 dark:from-slate-900 dark:via-purple-900/20 dark:to-slate-900">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {industry.challenges.map((challenge, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className="relative backdrop-blur-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-6 flex items-start gap-4 shadow-lg dark:shadow-none">
