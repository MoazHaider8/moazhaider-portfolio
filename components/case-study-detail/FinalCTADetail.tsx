...
export default function FinalCTADetail() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Let's discuss how I can help grow your business through strategic SEO
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/case-studies"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-white/10 backdrop-blur-sm text-white font-semibold border-2 border-white/30 hover:bg-white/20 transition-all duration-300"
            >
