...
import { TrendingUp, Award, Users, Target, ArrowRight, Loader2, CheckCircle } from "lucide-react";
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          description: "Contact request from About page",
        }),
      });
          ...
          >
            <div className="p-8 rounded-3xl bg-slate-800/50 backdrop-blur-xl border border-white/10 shadow-2xl">
              ...
              <p className="text-gray-300 mb-6">
                Ready to transform your search visibility? Get in touch for a free consultation.
              </p>
